/* ==========================================================================
   SetMaster 3 pages — scroll reveal + scroll-spy. No dependencies.

   Copied from hire/assets/js/reveal.js rather than rewritten (the plan says
   reuse it), with the hire-specific timeline selector dropped. Shared by the
   case study and the landing page.
