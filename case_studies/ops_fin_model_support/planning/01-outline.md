...
| D-009 | **Six image placeholders, `M-01`–`M-06`,** sized at final aspect ratio. | Same device and same reasoning as SM3 `A-01`–`A-08`: dropping the real file in changes nothing about the layout. Never a grey box, never a "coming soon." |
