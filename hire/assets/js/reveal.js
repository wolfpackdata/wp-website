/* ==========================================================================
   Hire pages — scroll reveal + scroll-spy. No dependencies.

   Two non-negotiables, both load-bearing:

   1. The `.js` class is added HERE, and the hidden initial state in hire.css
      is scoped to it. With JavaScript off, broken, or blocked, every element
      renders visible and the page is complete. A résumé that requires JS to be
      readable is a broken résumé — the same failure mode as the v2.1
      image-only header (resume_design/header-footer-spec.md §9).
